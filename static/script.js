...
function handleFileUpload(event) {
    ...
    if (file) {
        ...
        // Automatically send the file for summarization and analysis
        const formData = new FormData();
        formData.append('file', file);

        fetch('/analyze_and_summarize', {
                method: 'POST',
                body: formData,
            })
            .then(response => {
            ...
            .then(data => {
                    ...
                    if (data.summary && data.responses && data.responses.length > 0) {
                        // Display the summary and questions/responses
                    ...
                    // Handle cases with no meaningful responses
            ...
            .catch(error => {
                ...
                // Handle errors during the request or in the response
