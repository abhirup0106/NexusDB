...
// Assuming you have a form or button that triggers this function
// function getStock() {
//     const brand = document.getElementById('brand').value;
//     const color = document.getElementById('color').value;
//     const size = document.getElementById('size').value;
...
//     const data = { brand, color, size };

//     fetch('http://127.0.0.1:5000/getStock', {
//             method: 'POST',
//             headers: {
//                 'Content-Type': 'application/json'
//             },
...
//         .then(data => {
//             if (data.success) {
//                 // If stock quantity is found, display it
//                 document.getElementById('stock_quantity').innerText = `Stock Quantity: ${data.stock_quantity}`;
//             } else {
//                 // If no stock is found or an error occurred
//                 document.getElementById('stock_quantity').innerText = data.message || 'No stock found.';
//             }
//         })
//         .catch(error => {
//             console.error('Error:', error);
//             document.getElementById('stock_quantity').innerText = 'Error fetching stock information.';
//         });
// }
...
//     // Logic to update the stock quantity in the database
//     updateStockQuantityInDatabase(); // Replace with actual API call

//     // Hide the alert and stop the blinking
//     document.getElementById('stock-alert').style.display = 'none';
// }
...
// Call the function to fetch and populate dropdown
fetchColumns();
